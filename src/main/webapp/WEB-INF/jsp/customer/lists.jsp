      ...
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="name" value="${customerlist.name}" readonly>
            </div>
          </div>
          <div class="am-g am-margin-top">
            <div class="am-u-sm-4 am-u-md-2 am-text-right">客户行业</div>
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="industry" value="${customerlist.industry}" readonly>
            </div>
          </div>
		  <div class="am-g am-margin-top">
            <div class="am-u-sm-4 am-u-md-2 am-text-right">客户信息来源</div>
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="origin" value="${customerlist.origin}" readonly>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <div class="am-btn-group" data-am-button>
                <label class="am-btn am-btn-default am-btn-xs">
                  <input type="radio" name="options" id="option1"> 合资
                </label>
                <label class="am-btn am-btn-default am-btn-xs">
                  <input type="radio" name="options" id="option2"> 国企
                </label>
                <label class="am-btn am-btn-default am-btn-xs">
                  <input type="radio" name="options" id="option3"> 民营
                </label>
              </div>
            </div>
          </div>
		  <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="zipcode" value="${customerlist.zipcode}" readonly>
            </div>
          </div>
          <div class="am-g am-margin-top">
            <div class="am-u-sm-4 am-u-md-2 am-text-right">年营业额</div>
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="annualrevenue" value="${customerlist.annualrevenue}" readonly>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <div class="am-btn-group" data-am-button>
                <label class="am-btn am-btn-default am-btn-xs">
                  <input type="radio" name="options" id="option1"> 一星
                </label>
                <label class="am-btn am-btn-default am-btn-xs">
                  <input type="radio" name="options" id="option2"> 二星
                </label>
                <label class="am-btn am-btn-default am-btn-xs">
                  <input type="radio" name="options" id="option3"> 三星
                </label>
              </div>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="address" value="${customerlist.address}" readonly>
            </div>
          </div>
       <ul class="am-tabs-nav am-nav am-nav-tabs">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  ...
                  name="createtime"
				  value="<fmt:formatDate pattern = "yyyy-MM-dd" value = "${customerlist.createtime}" />">
                </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  ...
                  name="updatetime"
				  value="<fmt:formatDate pattern = "yyyy-MM-dd" value = "${customerlist.updatetime}" />">
                </div>
            </div>
          </div>

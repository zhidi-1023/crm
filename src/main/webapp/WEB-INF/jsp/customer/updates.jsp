      ...
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
		  ...
		  <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="origin" value="${customer.origin}">
            </div>
          </div>
          <div class="am-g am-margin-top">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
              <input type="text" name="annualrevenue" value="${customer.annualrevenue}">
            </div>
          </div>
          <div class="am-g am-margin-top">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  ...
                  name="createtime"
				  value="<fmt:formatDate pattern = "yyyy-MM-dd" value = "${customer.createtime}" />">
                </div>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  ...
                  name="updatetime"
				  value="<fmt:formatDate pattern = "yyyy-MM-dd" value = "${customer.updatetime}" />">
                </div>
            </div>
          </div>

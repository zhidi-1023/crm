    ...
    <div class="am-tabs am-margin" data-am-tabs>
      <ul class="am-tabs-nav am-nav am-nav-tabs">
		...
		<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">菜单管理</strong> / <small>添加商机</small>
					</div>
				</div>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<select name="Customerid">
						        ...
						        <option value="<%=item.getCustomerid() %>"><%=item.getName()%></option>	
						        <%} %>		       
						     </select>
					...
					<div class="am-g am-margin-top">
						...
						<div class="am-u-sm-8 am-u-md-4">
							<select name="Contactsid">
						        ...
						        <option value="<%=item.getContactsid() %>" ><%=item.getName()%></option>	
						        <%} %>		       
						     </select>
							...
							<select name="Statusid">
								<option value=""><%="请选择联系人" %></option>
			                  	<%for(TbCrmBusinessStatus item:businessstatusList) {%>
					              		 <option value="<%=item.getStatusid() %>"><%=item.getName()%></option>
						        <%} %>		       
						     </select>

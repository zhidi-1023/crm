...
<link rel="icon" sizes="192x192" href="${ctxPath }/static/amazeui/i/app-icon72x72@2x.png">
...
<meta name="msapplication-TileImage" content="${ctxPath }/static/amazeui/i/app-icon72x72@2x.png">
<meta name="msapplication-TileColor" content="#0e90d2">
<link rel="stylesheet" href="${ctxPath }/static/amazeui/css/amazeui.min.css">
<link rel="stylesheet" href="${ctxPath }/static/amazeui/css/app.css">
<style>
  .header {
    text-align: center;
  }

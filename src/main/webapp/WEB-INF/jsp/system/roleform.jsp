    ...
    <form class="am-form" method="post">
            ...
            <div class="am-g am-margin-top">
             ...
             角色说明           
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input type="text" class="am-input-sm" name="rolenote" value="${role.rolenote }">
              </div>
            ...
            创建时间          
              ...
              <div class="am-u-sm-8 am-u-md-4">
                <input type="date" class="am-input-sm" name="createtime" value="<fmt:formatDate pattern = "yyyy-MM-dd" value="${role.createtime }" />">
              </div>
              <div class="am-hide-sm-only am-u-md-6">选填</div>
            </div>
    <div class="am-margin">

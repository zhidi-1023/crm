...
<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
    <strong>京唐国际客户管理</strong> <small>后台</small>
  </div>
	...
	<div class="am-cf admin-main">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
         ...
         <a href="${ctxPath}/product/save" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
        	 <a href="${ctxPath}/product/list" class="am-btn am-btn-default"><span class="am-icon-plus"></span>产品工具</a>
         <a href="${ctxPath}/product/lista" class="am-btn am-btn-default"><span class="am-icon-plus"></span>产品类别</a>
         
      </div>
		<div class="am-g"><a href="${ctxPath}/product/list?where1=week">本周</a></div>
      <div class="am-g">
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              %>
              <tr>
                <td><input type="checkbox"  name="cbItem"  data-id="<%=item.getProductid()%> "/></td>
                		<td><%=index %></td>
               		<td><a href="#"><%=item.getName() %></a></td>
                		<td><a href="#"><%=item.getLink() %></a></td>
                		<td><a href="#"><%=session.getAttribute("username") %></a></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="${ctxPath }/product/check/<%=item.getProductid() %>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only procheck " data-id="<%=item.getProductid() %>"><span class="am-icon-pencil-square-o"></span>查看</a>
                      <a href="${ctxPath }/product/update/<%=item.getProductid()%>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                      <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only proDelete " data-id="<%=item.getProductid() %>"><span class="am-icon-trash-o"></span> 删除</a>
              ...
              <div class="am-fr">
                <ul class="am-pagination">
                 ...
                 <%if(pageNum<=1) {%>
                  ...
                  <%}else{ %>
                  <li class=""><a href="<%=ctxPath%>/product/list?pageNum=<%=pageNum-1%>&searchText=${searchText}">上一页</a></li>
                  <%} %>
                  ...
                  <li class="am-disabled"><a href="#">下一页</a></li>
                   <%}else{ %>
                  <li><a href="<%=ctxPath%>/product/list?pageNum=<%=pageNum+1%>&searchText=${searchText}">下一页</a></li>
                    <%} %>
                </ul>
              </div>
            </div>
